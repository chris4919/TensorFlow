...
ROOT_PATH="/Users/chris/Documents/TensorFlow/traffic"
...
match_count_f=float(match_count)
test_labels_count=float(len(test_labels))
accuracy = match_count_f / test_labels_count
